package com.sebcode.msproducts.user.service.impl;
...
import com.sebcode.msproducts.user.mapper.UserMapper;
...
import com.sebcode.msproducts.user.service.IUserService;
import com.sebcode.msproducts.exception.BadRequestException;
import com.sebcode.msproducts.exception.ResourceNotFoundException;
...
public class UserServiceImpl implements IUserService {
    ...
    public UserResponseDTO toggleUserStatus(Long userId) {
        ...
        log.info("User {} status changed to: {}", user.getEmail(), user.getState());
